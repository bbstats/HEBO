...
class MultiModalDataLoader(ABC):
    ...
    def __init__(self, config):
        data = {'seq_len': 0, 'batch_size': 64, 'nm_data_seq': 0,
                'nm_gen_seq': 250,
                'normalise': True,
                'path': '/home/alexc/antigenbinding-main-pipeline/data',
                'target': '1ADQ',
        ...
        self.config = {'optim': optim, 'model': model, 'seq2seq': seq2seq, 'data': data,
                       'model_path': "/home/alexc/antigenbinding-main-pipeline/data/models",
                       'results_path': "/home/alexc/antigenbinding-main-pipeline/data/results",
                       "gpu_id": 3,
                       "seed": 42,
                       "test_every": 1,
                       "save_every": 5,
