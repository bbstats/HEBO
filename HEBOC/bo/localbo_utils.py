...
class CDRH3Prob(Problem):
    ...
    def __init__(self, f_acq: Callable, n_var=11, n_obj=1, n_constr=3, xl=0, xu=19, cdr_constraints=True, device=torch.device('cpu'), dtype=torch.float32):
...
def glocal_search(x_center,
    ...
    termination = get_termination("n_gen", 11*20)
