...
# __file__ = "/home/kamild/projects/antigenbinding/genetic_algorithm/genetic_algorithm.py"  # TODO delete. Used for debugging
...
class GeneticAlgorithm:
    ...
    def sample_new_population(self, sorted_population):
        ...
        new_population[self.num_elite:, self.dim] = self.evaluate_batch(new_population[self.num_elite:, :self.dim])
